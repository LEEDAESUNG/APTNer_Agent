    ...
    class MySocket
    {
        ...
        private void ServerFunc(object obj)
        {
            ...
            while(true)
            {
                ...
                _MainForm.HomeLogger("[HostSock] RCV : " + GateNo + " " + CarNo + " " + InOut + " " + IsReg + " " + Dong + " " + Ho);
                _MainForm.HomeLogger("[APTner] SND : " + GateNo + " " + CarNo + " " + InOut + " " + IsReg + " " + Dong + " " + Ho);
